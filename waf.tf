...
resource "aws_wafv2_web_acl_logging_configuration" "day3" {
  provider = aws.us-east-1
  log_destination_configs = [aws_cloudwatch_log_group.day3.arn]
  resource_arn            = aws_wafv2_web_acl.waf.arn
  depends_on = [ aws_cloudwatch_log_group.day3 ]
}